                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-12 col-lg-6 p-t-10 p-b-10 text-style-tool basic-letter-spacing">
										...
										<div class="spinner line-height col-xs-6">
                                                ...
                                                <input type="text" value="12" data-css="line-height" data-html="line-height" data-after="" id="line-height" class="form-control">
                                                <div class="input-group-btn-vertical">
                                                        <button class="btn btn-default" type="button"><i class="fa fa-caret-up"></i></button>
                                                        <button class="btn btn-default" type="button"><i class="fa fa-caret-down"></i></button>
                                                </div>
...
{!! HTML::style('/app/Modules/Studios/Resources/Views/Classes/text/css/text-studio.css?v=3.6') !!}
@push('javascript')

<script src="/app/Modules/Studios/Resources/Views/Classes/text/js/class-text-builder.js?v=3.92"  type="text/javascript"></script>
