    ...
    <section class="container-fluid">
        <div class="row " id="builderContain">
            <div class="col-xs-12 col-sm-6 previewAray" class="text-center">
                    ...
                    <div class="row   firstchild form-horizontal">
                      ...
                      <div class="col-xs-12">
                            <div class="flat-area" data-previewclass>
                               @if ($tag === 'card')
                                    @include('studios::_partial.component.componenthtml.card')
                               @elseif ($tag === 'group_buttons')
                                    @include('studios::_partial.component.componenthtml.group_buttons')
                              @elseif ($tag === 'forms')
                                    @include('studios::_partial.component.componenthtml.forms')
                              @elseif ($tag === 'inputgroups')
                                    @include('studios::_partial.component.componenthtml.inputgroups')
                              @elseif ($tag === 'jumbotron')
                                    @include('studios::_partial.component.componenthtml.jumbotron')
                              @elseif ($tag === 'navbar')
                                    @include('studios::_partial.component.componenthtml.navbar')
                              @elseif ($tag === 'panels')
                                    @include('studios::_partial.component.componenthtml.panels')
                               @elseif ($tag === 'tables')
                                    @include('studios::_partial.component.componenthtml.tables')
                               @elseif ($tag === 'table')
                                    @include('studios::_partial.component.componenthtml.tables')
                                @elseif ($tag === 'menu')
                                    @include('studios::_partial.component.componenthtml.menu')
                              	@elseif ($tag === 'list')
                                    @include('studios::_partial.component.componenthtml.list')
                               @else
                             ...
                             @if ($tag === 'default')
                           <div class="p-t-40">
                              <input type="file" id="uploderhtml">
                          </div>
                          @endif
                          <div class="p-t-20">
                ...
                <textarea name="json_data" class="form-control" data-export="json" hidden="hidden" style="margin-top:100px">{!! $data_edit['jsonData'] or null !!}</textarea>
...
{!! HTML::script('/app/Modules/Studios/Resources/Views/assets/component/component-class-builder.js?v=46') !!}
