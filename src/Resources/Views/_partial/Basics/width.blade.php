                    ...
                    <div class="" data-role="classview">Lorem ipsum dolor sit amet, </div>
                        ...
                        <div class="col-xs-12 col-sm-6 formoptions containerBuilderEditor">
                                <ul class="stepNav nav-justified list-unstyled tabStepnav clearfix m-t-10 hide" data-tabnav="button">
                                        ...
                                        <li><a href="#" title="Step1" data-rolecss="hover" class="clearfix col-xs-12"><span class="col-xs-6 text-right p-r-0">Hover</span>
                                        ...
                                        <li><a href="#" title="Step1" data-rolecss="selected" class="clearfix col-xs-12"> <span class="col-xs-6 text-right p-r-0">Selected</span>
                                                        <span class="col-xs-6 text-left">
                                                                <label class="switch switch-flat switch-button m-b-0">
                                        ...
                                        <div class="col-xs-12 studio-collapse-toobar collapse in " id="collapsecontainerHeight">
                                                <div class="p-10">
                                                        <div data-collapsegroup="width">
                                                                <div class="row">
                                                                        <div class="col-xs-6 col-md-6 col-lg-2 p-t-10 p-b-10 m-t-5">Container width</div>
                                                                        <div class="col-xs-9 p-t-10 p-b-10">
...
<script src="/app/Modules/Studios/Resources/Views/Classes/container/js/class-container-builder.js?v=60" type="text/javascript"></script> 
@endpush