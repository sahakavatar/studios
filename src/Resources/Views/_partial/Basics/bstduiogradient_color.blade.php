<div class="menuBuilder colorBuilderPreview">
        <section class="container-fluid" >
                <div class="row" id="builderContain">
                        ...
                        <div class="col-xs-12 col-sm-12 formoptions editDesignCol"> 
...
<link media="all" type="text/css" rel="stylesheet" href="/app/Modules/Studios/Resources/Views/assets/color/css/color-builder.css?v=0.26">
<style>
            #builderContain{
                top: 0 !importent;
            }

            .previewAray, #menuBuilderHeader{
