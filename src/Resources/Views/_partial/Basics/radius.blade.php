                    ...
                    <div class="" data-role="classview">Lorem ipsum dolor sit amet, </div>
                        ...
                        <div class="col-xs-12 col-sm-6 formoptions containerBuilderEditor">
                                ...
                                <div class="row formrow form-horizontal">
                                        <div class="col-xs-12 studio-collapse-header p-t-10"> <span class="pull-left"> <a data-toggle="collapse" href="#collapseBorderRadius" class="iconstudio viewicon  m-r-5" data-viewpopup="container"> <i class="fa fa-angle-down" aria-hidden="true"></i> </a>  Radius </span> <span class=" m-l-10 pull-left">
                                        ...
                                        <div class="col-xs-12 studio-collapse-toobar collapse in" id="collapseBorderRadius">
                                                ...
                                                <div class="row">
                                                        <div class="col-xs-12 col-md-12 col-lg-8 p-t-10 p-b-20 border-section">
                                                                <div class="col-xs-12">
...
<script src="/app/Modules/Studios/Resources/Views/Classes/container/js/class-container-builder.js?v=80" type="text/javascript"></script> 
@endpush