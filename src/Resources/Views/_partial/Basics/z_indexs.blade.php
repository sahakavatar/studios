                    ...
                    <div class="col-xs-12 studio-collapse-toobar collapse in" id="animationcontainer">
                            <div class="row formrow form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-3"><span class="iconform arrowicon"></span> Z-index</div>
                                    <div class="col-xs-3 p-l-0">
                                        <div class="spinner dual">
                                            <input type="text" value="auto" data-role="editcss" data-html="z-index"  data-css="z-index" data-default="auto"  class="form-control spacing-value">
...
{!! HTML::script("/app/Modules/Studios/Resources/Views/Classes/container/js/class-container-builder.js?v=80") !!}
@endpush
