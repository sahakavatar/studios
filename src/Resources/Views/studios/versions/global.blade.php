        ...
        <section class="container-fluid">
            <div class="row " id="builderContain">
                <div class="col-xs-12 col-sm-6 previewAray" class="text-center">
                    ...
                    <div class="classnamedetail m-b-15 hide ">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-inline ">
                                    <button type="button" class="btn uploadButton" data-buttonrole="results" >
                                        View Results
                                    </button>

                                    <div class="btn-group">
                                        <button type="button" class="btn uploadButton dropdown-toggle btn-block" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fa fa-css3" aria-hidden="true"></i> <span data-actviestduio="">Defult</span>  <span class="caret"></span>
                                        </button>
                                        <ul class="dropdown-menu" data-role="cssselectorttree" data-tabnav="button">
                                            <li class="active"><a href="#" data-rolecss="css" data-buttonrole="addcssselector" data-cssselector="Defult" data-targetselector="Defult">Defult</a></li>
                                        </ul>
                                    ...
                                    <div class="form-group">
                                        <label class="p-l-20">Add Css Selector</label>
                                        <select class="form-control hide" data-selectcssmaster="target">
                    ...
                    <div class="row p-b-10 hide">
                        <div class="col-xs-12 p-0">
                            ...
                            <ul class="stepNav list-unstyled nav-justified tabStepnav previewtabs clearfix  hide" >
                                <li  ><a href="#" title="Step1" >Default</a></li>
                                ...
                                <li><a  href="#tabpreview" data-rolecss="results" aria-controls="home" role="tab" data-toggle="tab" ><i class="glyphicon glyphicon-eye-open"></i></a></li>
                            </ul>
                    ...
                    <textarea name="json_data" class="form-control" data-export="json" style="margin-top:100px">{!! @$json_data !!} </textarea>
                    ...
                    <textarea name="collection" class="form-control" data-export="collectiondata" hidden="hidden"></textarea>
                    <div class="editcontianer m-t-20"><div id="editorexportcss"></div></div>
                ...
                <div class="col-xs-12 col-sm-6 formoptions textBuilderEditor p-0 ">
                    ...
                    <div class="row formrow form-horizontal">
                        <!--<div class="col-xs-12 p-t-10 p-b-5">
                                ...
                                <button type="button" class="basicsBtn m-r-10" data-opstudios="basic" data-buttonrole="getbasic" data-type="text_parts" >Basic Classes</button>
                                <button type="button" class="basicsBtn m-r-10" data-opstudios="element" data-buttonrole="getbasic" data-type="containers" >Element classes</button>
                                <button type="button" class="basicsBtn m-r-10" data-opstudios="textclasses" data-buttonrole="getbasic" data-type="text" >Text classes</button>
                                <button type="button" class="basicsBtn m-r-10" data-opstudios="containerclasses" data-buttonrole="getbasic" data-type="container" >Container classes</button>
                                <button type="button" class="basicsBtn m-r-10" data-opstudios="imageclasses" data-buttonrole="getbasic" data-type="image" >Image classes</button>
                                <button type="button" class="basicsBtn m-r-10" data-opstudios="listsclasses" data-buttonrole="getbasic" data-type="lists" >List Style classes</button>
                    ...
                    <div data-previewcolumn="option">
                        ...
                        <ul class="stepNav list-unstyled nav-justified tabStepnav clearfix m-t-10 " role="tablist" data-studitabs="opstudios">
                            ...
                            <li data-opstudios="filter"><a  href="#filterstyles" aria-controls="filter" role="tab" data-toggle="tab" >Filter</a></li>
                            <li data-opstudios="liststyle"><a  href="#liststyle" aria-controls="liststyle" role="tab" data-toggle="tab" >List Styling</a></li>
                            ...
                            <li data-opstudios="imagecollections"><a  href="#imagecollectionsstyle" aria-controls="collectionstyles" role="tab" data-toggle="tab" >Image Classes </a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="textstyles" data-opstudios="text" data-fieldactive="text">
                                ...
                                <div class="studio-collapse-toobar collapse" data-targetStudioType="custom">
                                    <div class="row formrow form-horizontal p-b-10">
                                ...
                                <div class="collapse" data-targetStudioType="select">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <ul class="list-unstyled template-files existingclass clearfix" data-classeslsit="text_parts">
                            ...
                            <div role="tabpanel" class="tab-pane" id="contianerstyles" data-opstudios="container" data-fieldactive="container">
                                ...
                                <div class="row formrow form-horizontal m-l-0 m-r-0 m-b-10">
                                    <div class="col-xs-12 col-md-6 col-md-offset-3">
                                        <select  class="form-control customselect"  data-style="class-style-menu" data-switchStudio="container" data-studio="container" data-html="editcontainerStudio" >
                                            <option value="custom">CSS Editor</option>
                                            <option value="create">Studio</option>
                                        </select>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="liststyle" data-opstudios="liststyle">
                                <div class="row formrow form-horizontal" data-opstudios="classes">
                                    <div class="col-xs-12 studio-collapse-header p-t-10 "> <span class=" pull-left"> <button type="button" data-toggle="collapse" href="#collapsecontainerlistclasses" class="iconstudio viewicon m-r-5 collapsed" data-viewpopup="container"> <i class="fa fa-angle-down" aria-hidden="true"></i> </button> List style classes </span>   <span class=" m-l-10 pull-left">
                                                <label class="switch switch-flat switch-button">
                                                        <input class="switch-input" type="checkbox" data-switch="collapsecontainerlistclasses" data-cssexist="height"/>
                                                        <span class="switch-label" data-on="On" data-off="Off"></span> <span class="switch-handle "></span> </label>
                                                </span>  <a href="#" class="iconstudio addicon m-r-5 pull-right" ><i class="fa fa-power-off f-s-20" aria-hidden="true"></i></a>  </div>



                                    <div class="col-xs-12 studio-collapse-toobar collapse " id="collapsecontainerlistclasses">
                                        <div class="p-10">
                                                ...
                                                <div class="studio-collapse-toobar" style="background-color: transparent">
                                                    <div class="row b-b-1">
                                                        ...
                                                        <div class="col-xs-12 col-md-5 col-lg-5  p-t-10 p-b-10">
                                                            <div class="width100">
                                                                <div class="spinner letter-spacing" style="width: 100%">
                            ...
                            <div role="tabpanel" class="tab-pane" id="filterstyles" data-opstudios="filter">
                                <div class="row formrow form-horizontal">
                                    <div class="col-xs-12 studio-collapse-header p-t-10 p-b-10">
                            <span class=" pull-left">
                                <a data-toggle="collapse" href="#filtercontainer" class="iconstudio viewicon m-r-5 collapsed" data-viewpopup="container">
                                    <i class="fa fa-angle-down" aria-hidden="true"></i>
                                </a> Filter
                            </span>
                                        <a href="#" class="iconstudio addicon m-r-5 pull-right" ><i class="fa fa-power-off f-s-20" aria-hidden="true"></i></a>
                                    </div>
                                    <div class="col-xs-12 studio-collapse-toobar collapse" id="filtercontainer">
                                        <div class="row p-15" data-role="filterGroup">
                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 p-b-10">
                                                <label for="value" class="col-sm-3"><span class="iconform arrowicon"></span> Blur</label>
                                                <div class="col-sm-8 p-t-10">
                                                    <div id="blur" class="fullSliderw settingSlider greenSlider m-t-5" data-multycss="filter"  data-css-after="px" data-slide-min="0" data-slide-max="10" data-slide-step="1" data-slide-val="0"> </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 p-b-10">
                                                <label for="value" class="col-sm-3"><span class="iconform arrowicon"></span> Sepia</label>
                                                <div class="col-sm-8 p-t-10">
                                                    <div id="sepia" class="fullSliderw settingSlider greenSlider m-t-5" data-multycss="filter"  data-css-after="%" data-slide-min="0" data-slide-max="100" data-slide-step="10" data-slide-val="0"> </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 p-b-10">
                                                <label for="value" class="col-sm-3"><span class="iconform arrowicon"></span> Grayscale</label>
                                                <div class="col-sm-8 p-t-10">
                                                    <div id="gr" class="fullSliderw settingSlider greenSlider m-t-5" data-multycss="filter"  data-css-after="%" data-slide-min="0"  data-slide-max="100" data-slide-step="10" data-slide-val="0"> </div>
                                                </div>
                                            </div>

                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 p-b-10">
                                                <label for="value" class="col-sm-3"><span class="iconform arrowicon"></span> Saturate</label>
                                                <div class="col-sm-8 p-t-10">
                                                    <div id="st" class="fullSliderw settingSlider greenSlider m-t-5" data-multycss="filter"  data-css-after="%" data-slide-min="0" data-slide-max="500" data-slide-step="10" data-slide-val="0"> </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 p-b-10">
                                                <label for="value" class="col-sm-3"><span class="iconform arrowicon"></span> Hue-rotate</label>
                                                <div class="col-sm-8 p-t-10">
                                                    <div id="hue" class="fullSliderw settingSlider greenSlider m-t-5" data-multycss="filter"  data-css-after="deg" data-slide-min="0" data-slide-max="360" data-slide-step="10" data-slide-val="0"> </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 p-b-10">
                                                <label for="value" class="col-sm-3"><span class="iconform arrowicon"></span> Invert</label>
                                                <div class="col-sm-8 p-t-10">
                                                    <div id="inv" class="fullSliderw settingSlider greenSlider m-t-5" data-multycss="filter"  data-css-after="%" data-slide-min="0" data-slide-max="100" data-slide-step="10" data-slide-val="0"> </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 p-b-10">
                                                <label for="value" class="col-sm-3"><span class="iconform arrowicon"></span> Brightness</label>
                                                <div class="col-sm-8 p-t-10">
                                                    <div id="br" class="fullSliderw settingSlider greenSlider m-t-5" data-multycss="filter"  data-css-after="%" data-slide-min="0" data-slide-max="200" data-slide-step="10" data-slide-val="0"> </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-sm-12 col-md-12 col-lg-12 p-b-10">
                                                <label for="value" class="col-sm-3"><span class="iconform arrowicon"></span> Contrast</label>
                                                <div class="col-sm-8 p-t-10">
                                                    <div id="cont" class="fullSliderw settingSlider greenSlider m-t-5" data-multycss="filter"  data-css-after="%" data-slide-min="0" data-slide-max="200" data-slide-step="10" data-slide-val="0"> </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('JS')
  {!! HTML::script('/app/Modules/FrameworkVersions/Resources/Views/assets/containertext/js/class-containertext-builder.js?=v417') !!}
@stop