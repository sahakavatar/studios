        ...
        <section class="container-fluid" >
                <div class="row" id="builderContain">
                        <div class="col-xs-12 col-sm-6 previewAray">
                                ...
                                <textarea name="json_data" class="form-control " data-export="json" style="margin-top:140px;"></textarea>
...
<link media="all" type="text/css" rel="stylesheet" href="/appdata/app/Modules/Studio/Resources/Views/classes/color-picker/css/color-builder.css?v=0.20">
@push('javascript') 
...
<script src="/appdata/app/Modules/Studio/Resources/Views/classes/color-picker/js/class-color-builder.js?v=0.32" type="text/javascript"></script> 
@endpush