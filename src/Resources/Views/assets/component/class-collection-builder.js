$(function(){
  ...
  $('[data-role="selectStudio"]').val('text').selectpicker('refresh');
      ...
      less:"",
       ...
       $('[data-export="csspreve"]').val(classb.generalSetting.csssetting.savedcss)
         ...
         // classb.compile()
          ...
          classb.generalSetting.csssetting['collection'] ='$'+classb.generalSetting.csssetting.class+":"+ classater;
         ...
         // alert(classater)
			...
			updatecss:function(){
				...
				if(classb.generalSetting.csssetting.collection){
					$('[data-export="collectiondata"]').val(classb.generalSetting.csssetting.collection)
				}
				if(!modestduio){
   ...
   /* $.get("/admin/framework-versions/version/get-css-live", function(data){
      	classb.less = data;
        classb.less += '{{{lesscss}}}';
