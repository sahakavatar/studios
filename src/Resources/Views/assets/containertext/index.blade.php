                ...
                <div class="row " id="builderContain">
                    ...
                    <div class="" data-role="classview">Lorem ipsum dolor sit amet, </div>
                        ...
                        <div class="col-xs-12 col-sm-6 formoptions containerBuilderEditor">
                                <ul class="stepNav  nav-justified list-unstyled tabStepnav clearfix m-t-10" data-tabnav="button">
                                ...
                                <div class="row formrow form-horizontal">
                                        <div class="col-xs-12 studio-collapse-header p-t-10 "> <span class=" pull-left"> <a data-toggle="collapse" href="#collapsecontainerHeight" class="iconstudio viewicon m-r-5" data-viewpopup="container"> <i class="fa fa-angle-down" aria-hidden="true"></i> </a> Container </span>   <span class=" m-l-10 pull-left">
                                        ...
                                        <div class="col-xs-12 studio-collapse-toobar collapse in " id="collapsecontainerHeight">
                                                <div class="p-10">
                                                        ...
                                                        <div class="collapse" data-showcontainer="containerAsset">
                                                              <div class="p-10">
                                                                  <ul class="list-unstyled clearfix imgTypes">
                                                                        <li><a href="#" data-loadasset="assest1"><img src="/appdata/app/Modules/Studio/Resources/Views/classes/container/img/img-type-left.png" alt=""></a></li>
                                                                        <li><a href="#" data-loadasset="assest2"><img src="/appdata/app/Modules/Studio/Resources/Views/classes/container/img/img-type-center.png" alt=""></a></li>
                                                                        <li><a href="#" data-loadasset="assest3"><img src="/appdata/app/Modules/Studio/Resources/Views/classes/container/img/img-type-right.png" alt=""></a></li>
                                                                        <li><a href="#" data-loadasset="assest4"><img src="/appdata/app/Modules/Studio/Resources/Views/classes/container/img/img-type-block.png" alt=""></a></li>
                                                                  </ul>
                                                              </div>
                                                        </div>
                                ...
                                <div class="row formrow form-horizontal">
                                        <div class="col-xs-12 studio-collapse-header p-t-10 "> <span class=" pull-left"> <a data-toggle="collapse" href="#collapseBackground" class="iconstudio viewicon m-r-5" data-viewpopup="container"> <i class="fa fa-angle-down" aria-hidden="true"></i> </a> Background </span> <span class=" m-l-10 pull-left">
                                                <label class="switch switch-flat switch-button">
                                ...
                                <div class="row formrow form-horizontal">
                                        <div class="col-xs-12 studio-collapse-header p-t-10"> <span class="pull-left"> <a data-toggle="collapse" href="#collapseBorderRadius" class="iconstudio viewicon  m-r-5" data-viewpopup="container"> <i class="fa fa-angle-down" aria-hidden="true"></i> </a> Border and Radius </span> <span class=" m-l-10 pull-left">
                                                <label class="switch switch-flat switch-button">
