        ...
        <section class="container-fluid" >
                <div class="row" id="builderContain">
                        ...
                        <div class="col-xs-12 col-sm-6 formoptions editDesignCol"> 
                                ...
                                <!--  Tabs -->
                                <ul class="stepNav list-unstyled tabStepnav tabNavs tabNavMenu clearfix" data-inset="nav" >
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="image"> 
                                                ...
                                                <div class="row styleRow form-horizontal">
                                                        <div class="form-group">
                                                                ...
                                                                <div class="col-lg-4 col-xs-12">
                                                                       	<div class="uploadImg"><img src="/public/img/baboon.png" data-imageurl="" alt=""></div>
...
<link media="all" type="text/css" rel="stylesheet" href="/appdata/app/Modules/Studio/Resources/Views/classes/color/css/color-builder.css?v=0.20">
@push('javascript') 
...
<script src="/appdata/app/Modules/Studio/Resources/Views/classes/color/js/class-color-builder.js?v=0.32" type="text/javascript"></script> 
@endpush